...
public class NoticeTest {
	...
	public void createNotice() throws ParseException{
		...
		// Creazione Avviso
		Map<String, Object> response = frontOfficeService.post(null, null,
				null, null, null, null, TypeDocument.Notice, stackTrace);
	...
	public void testEditNotice() throws IOException, ParseException{
		...
		String stackTraceUpdate = "{\"avvisi:number\":\"21\",\"avvisi:style\":\"success\",\"avvisi:type\":\""
				...
				+ nodeRefNotice + "\"}";
		nodeRefNotice = (String) frontOfficeService.post(null, null, null,
				null, null, null, TypeDocument.Notice, stackTraceUpdate).get(
				"objectId");
