define(['jquery', 'cnr/cnr.ui', 'json!common', 'i18n', 'json!cache'], function ($, UI, common, i18n, cache) {
  ...
  var xhrs = {},
    ...
    urls = {
      proxy: {
        groups: "rest/proxy" + "?url=service/search/autocomplete/group",
        myGroupsDescendant: "rest/proxy" + "?url=service/search/groups/descendant/$user_id",
        ...
        taskProperties: "rest/proxy" + "?url=service/workflow/tasks/properties",
        tasks: "rest/proxy" + "?url=service/api/task-instances",
        endTask: 'rest/proxy' + '?url=service/api/task/$taskId/formprocessor',
        person: "rest/proxy" + "?url=service/search/autocomplete/person",
        permissions: 'rest/proxy' + '?url=service/cnr/permissions/$node',
        people: 'rest/proxy' + '?url=service/cnr/person/$user_id',
        peopleFilter: 'rest/proxy' + '?url=service/api/people',
        peopleSearch: 'rest/proxy' + '?url=service/cnr/people',
        disableAccount: 'rest/proxy' + '?url=service/cnr/disableAccount',
        ...
        jsRemote: 'rest/proxy' + '?url=service/jsRemote',
        workflowProperties: 'rest/proxy' + '?url=service/workflow/properties',
        definitionDiagram: 'rest/proxy' + '?url=service/workflow/diagram.png&definitionId=$workflowDefinitionId',
        childrenGroup: 'rest/proxy' + '?url=service/authority/groups/children',
        rootGroup: 'rest/proxy' + '?url=service/authority/groups/root',
        group: 'rest/proxy' + '?url=service/authority/group',
        metadata: 'rest/proxy' + '?url=service/api/metadata',
        metadataNode: 'rest/proxy' + '?url=service/api/metadata/node/$store_type/$store_id/$id',
        version: 'rest/proxy' + '?url=service/cnr/nodeversion'
      },
      ...
      countries: 'search/paesi',
      cities: 'search/comuni',
      rbac: 'rest/rbac',
      ...
      search: {
        ...
        demux: 'rest/proxy' + '?url=service/demux'
      },
      node: {
